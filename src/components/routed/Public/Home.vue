  ...
  data () {
    return {
      ...
      surgeTable: ["Roll on this table every round for 1 minute, ignoring duplicate rolls.",
        ...
        "The caster teleports up to 60 feet to unoccupied space.",
        ...
        "1d6 flumphs appear for 1 minute within 60ft of the caster. They are surprised by their appearance and generally scared.",
        "The caster and target flung 10ft in opposite directions",
        ...
        "The caster is distracted by cloud of gnats for 1 minute. During this time, he or she has disadvantage on concentration checks.",
        "For 1 minute the caster can teleport up to 20ft as bonus action.",
        "The spell ricochets off of the target to random creature in 30ft. The initial target suffers no effects from the spell.",
        ...
        "A unicorn appears within 5ft of the caster. After one minute it disappears.",
        ...
        "The caster falls unconscious until start of their next turn.",
        "The target is frightened of the nearest creature until end of their next turn.",
        ...
        "The caster must make a DC 13 Wisdome saving throw. On a failure they are turned in to a sheep for 1 minute. On a success, they instead choose the form of any beast whose challenge rating is equal to or less than their level.",
        "If the spell deals damage, the target loses a limb.",
        "Illusory butterflies and flowers flutter around the caster for 1 min.",
        "The caster is trapped in a giant glass ball.",
        "After the spell is cast, the caster immediately takes an additional action.",
        "Caster’s fists become huge for 1 minute. They are considered a melee weapon with which the caster is proficient. They deal 1d8 bludgeoning damage.",
        ...
        "The caBecome invisible/silent for 1 minute or till atk/cast",
        "Cast invisibility on yourself without expending a spell slot.",
        "If the target dies within 1 minute, it immediately comes back to life as per the spell reincarnate.",
